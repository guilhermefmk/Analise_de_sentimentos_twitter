    ...
    def on_data(self, raw_data):
        ...
        if 'includes' in raw_data:
            ...
            if self.contador >=100:
                name = data.replace(':','-')
                self.s3.Object('raw-layer-bucket-xpto', f'tweeter/sa-east-1/tweeter_eleicoes/2022/Lula/{name}.json').put(Body=json.dumps(self.listajson,ensure_ascii=False))
                # with open(f'/home/guilherme.cunha/Área de Trabalho/WORKSPACE/Compass/Testes/{name}.json', 'w', encoding='utf-8') as f:
